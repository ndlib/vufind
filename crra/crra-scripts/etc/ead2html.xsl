...
<xsl:template match="/">
	...
	<xsl:template name="head">
		...
		<title>
			<xsl:value-of select="ead/eadheader/filedesc/titlestmt/titleproper" /><xsl:text>:</xsl:text>
...
<xsl:template name="cover">
	<xsl:for-each select="ead/eadheader/filedesc/titlestmt">
		<p style="text-align:center">
			<a name="a0">
				<a href='http://www.catholicresearch.net/'><img src="http://www.catholicresearch.net/interface/themes/crranew/css/images/header.png" width='600' /></a>
			</a>
		</p>
